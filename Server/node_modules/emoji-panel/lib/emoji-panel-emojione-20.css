...
.ep-e {
  width: 20px;
  background-image: url('../../emoji-datasource/sheet_emojione_20.png');
}
.ep-slide {
  width: 12.5%;
}
...
.ep-e[data-index="1298"], .ep-e[data-index="1291"], .ep-e[data-index="1299"], .ep-e[data-index="1292"], .ep-e[data-index="17"], .ep-e[data-index="822"] {
  display: none;
}
